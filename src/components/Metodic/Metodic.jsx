                ...
                <div className="parent">
                    ...
                    <div className="div2">
                        <div className="flex__childs-items">
                            ...
                            <p>
                                ...
                                проекты во время обучения и готовит к реалиям
                                IT-компаний.
                            </p>
                        </div>
                    </div>
                    <div className="div3">
                        <div className="flex__childs-items">
                            ...
                            <p>
                                Более 60% обучения - работа над проектами. Ты
                                будешь кодить не только дома, но и прямо на
                                уроках. К концу курса это позволит сформировать
                                настоящее партфолио работ.
                            </p>
                        </div>
                    </div>
                    <div className="div4">
                        <div className="flex__childs-items">
                            ...
                            <p>
                                Мы формируем небольшие группы - по 25 человек.
                                Такую группу курирует 2 ментора и 1 глава
                                направления. Это позволяет уделить персональное
                                внимание каждому. Ответы на вопросы, поддержка в
                                чате, персональные интервью и индивидуальная
                                проверка домашних заданий и экзаменов - все
                                включено.
                            </p>
                        </div>
                    </div>
                    <div className="div5">
                        <div className="flex__childs-items">
                            ...
                            <h3>Доступ 24/7</h3>
                            <p>
                                Все учебные материалы и записи уроков, доступны
                                тебе круглосуточно. Учись в темпе, который
                                подходит лично тебе.
                            </p>
                        </div>
                    </div>
                    <div className="div6">
                        <div className="flex__childs-items">
                            ...
                            <p>
                                Если у тебя достаточно времени и сил, чтобы
                                освоить сразу несколько направлений - мы не
                                против! Поступая в Академию на 6-месячный курс
                                по IT профессии, ты получаешь доступ ко всем
                                курсам своего потока. Опережаешь программу по
                                Java - изучи Frontend!
                            </p>
                        </div>
                    </div>
